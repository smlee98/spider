...
export function MainNav() {
    return (
        <div className="mr-4 hidden w-full md:flex">
            <nav className="flex items-center justify-between gap-6 text-sm w-full">
                <NavigationMenu>
                    <NavigationMenuList>
                        <NavigationMenuItem>
...
export function MobileNav() {
    ...
    return (
        <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent
                side="right"
                className="flex h-dvh w-dvw flex-col px-0"
            >
                ...
                <ScrollArea className="flex-1">
                    <ul
                        role="list"
                        className="my-4 flex flex-col gap-6 px-6 text-2xl font-bold"
                    >
                        <li>
                            <Accordion
                                type="single"
                            ...
                            >
                                <AccordionItem
                                    value="solution"
                                    className="bg-background divide-y-0"
                                >
...
interface ListItemProps
    extends Omit<ComponentPropsWithoutRef<typeof Link>, "title"> {
...
interface MobileLinkProps
    extends Omit<ComponentPropsWithoutRef<typeof Link>, "onClick"> {
    href: string;
