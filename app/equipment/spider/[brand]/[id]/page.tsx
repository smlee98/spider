          ...
          <Card className="gap-0">
            ...
            <CardContent className="px-0">
              <Table>
                <TableBody>
                  <TableRow>
                    <TableCell className="text-muted-foreground px-6 font-semibold">{dictSpider.bodyWeight}</TableCell>
                  ...
                  <TableRow>
                    <TableCell className="text-muted-foreground px-6 font-semibold">{dictSpider.maxSafeLoad}</TableCell>
