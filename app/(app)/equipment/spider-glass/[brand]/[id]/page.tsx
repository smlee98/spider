      ...
      <Container>
        <div className="flex flex-col gap-6">
          <div className="flex items-end justify-between gap-4">
            ...
            <Link href="/equipment/spider-glass" className={buttonVariants({ variant: "outline" })}>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <ImageZoom
              src={`/equipment/spider-glass/${brand.brandName}/${equipment.modelName}/${equipment.modelName}.png`}
              alt={`${brand.brandName}/${equipment.modelName}`}
              className="w-full"
              zoomLevel={3.5}
            />
