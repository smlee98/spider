        ...
        <div className="flex flex-col gap-6">
          <div className="flex items-end justify-between gap-4">
            <div className="flex flex-col">
              ...
              <h1 className="text-foreground text-3xl font-black md:text-4xl">
                {equipment.modelName} {equipment.addOn}
              </h1>
            </div>
            <Link href="/equipment/spider-grapple" className={buttonVariants({ variant: "outline" })}>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <ImageZoom
              src={`/equipment/spider-grapple/${brand.brandName}/${equipment.modelName}/${equipment.modelName}.png`}
              alt={`${brand.brandName}/${equipment.modelName}`}
              className="w-full"
              zoomLevel={3.5}
            />
              ...
              <CardContent className="px-0">
                <Table>
                  <TableBody>
                    ...
                    {equipment.weightWithAddOn && (
                      <TableRow>
                        <TableCell className="text-muted-foreground px-6 font-semibold">
                          {dictSpider.withAddonWeight}
                        </TableCell>
                        <TableCell className="px-6">{equipment.weightWithAddOn}</TableCell>
                      </TableRow>
                    )}
                    <TableRow>
                      <TableCell className="text-muted-foreground px-6 font-semibold">
                    ...
                    {equipment.angleVertical && (
                      <TableRow>
                        <TableCell className="text-muted-foreground px-6 font-semibold">
                          {dictSpider.angleVertical}
                        </TableCell>
                        <TableCell className="px-6">{equipment.angleVertical}</TableCell>
                      </TableRow>
                    )}
                    {equipment.angleHorizontal && (
                      <TableRow>
                        <TableCell className="text-muted-foreground px-6 font-semibold">
                          {dictSpider.angleHorizontal}
                        </TableCell>
                        <TableCell className="px-6">{equipment.angleHorizontal}</TableCell>
                      </TableRow>
                    )}
                    {equipment.rotationAngle && (
                      <TableRow>
                        <TableCell className="text-muted-foreground px-6 font-semibold">
                          {dictSpider.rotationAngle}
                        </TableCell>
                        <TableCell className="px-6">{equipment.rotationAngle}</TableCell>
                      </TableRow>
                    )}
                    {equipment.pipeLiftDiameter && (
                      <TableRow>
                        <TableCell className="text-muted-foreground px-6 font-semibold">
                          {dictSpider.pipeLiftDiameter}
                        </TableCell>
                        <TableCell className="px-6">{equipment.pipeLiftDiameter}</TableCell>
                      </TableRow>
                    )}
                  </TableBody>
                </Table>
